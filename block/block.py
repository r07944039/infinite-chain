...
class Block_header():
    def __init__(self, prev_block, transactions_hash, target, nonce, beneficiary, transactions, balance):
...
class Block():
    def __init__(self, prev_block, transactions_hash, target, nonce, beneficiary, transactions, balance):
        block_header = Block_header(prev_block, transactions_hash, target, nonce, beneficiary, transactions, balance)
